...
//     int helper(vector<pair<int,int>>vpr, int m ,int n,int i){
...
//         return max( helper(vpr,m-vpr[i].first,n-vpr[i].second,i-1)+1, helper(vpr,m,n,i-1) );
...
//             vpr.push_back(count(strs[i]));
//         }
        
//         int sz = strs.size();
//         sz--;
        
//         return helper(vpr,m,n,sz);
//     }
// };
